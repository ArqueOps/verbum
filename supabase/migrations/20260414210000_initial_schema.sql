...
CREATE INDEX idx_studies_owner ON studies(owner_id);
CREATE INDEX idx_studies_slug ON studies(slug);
CREATE INDEX idx_studies_published ON studies(is_published) WHERE is_published = true;

-- Additional useful indexes
CREATE INDEX idx_books_position ON books(position);
CREATE INDEX idx_bible_versions_language ON bible_versions(language);
CREATE INDEX idx_user_api_credentials_user ON user_api_credentials(user_id);
